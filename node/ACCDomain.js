...
(function () {
    ...
    /**
     * @private
     * Handler function for the ACC.execmd command.
     * @return true
     */
    ...
    */
    ...
    function setExecPermissions() {
        ...
        var cmd1 = "chmod 755 '" + __dirname + "/../SDK/setdebugmode.sh'";
        log("Exec:" + cmd1);       
        exec(cmd1, function (error, stdout, stderr) {if (error !== null) {log(error);}});        
        
        var cmd2 = "chmod 755 '" + __dirname + "/../SDK/createext.sh'";
        /*
        if (!isMac) {
            cmd2 = 'cacls ' + __dirname + '\\SDK\\createext.bat /e /g everyone:f';
        }
        */
        log("Exec:" + cmd2);
    ...
    function init(DomainManager) {
        ...
        if (!DomainManager.hasDomain("ACC")) {
            DomainManager.registerDomain("ACC", {major: 0, minor: 1});
        }
